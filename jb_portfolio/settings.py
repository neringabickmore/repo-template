...
if DEBUG:
    ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'jamesbickmore.herokuapp.com','www.jamesbickmore.com', 'www.jamesbickmore.co.uk']
else:
    ALLOWED_HOSTS = ['jamesbickmore.herokuapp.com', 'www.jamesbickmore.com', 'www.jamesbickmore.co.uk']
